...
import com.nchain.jcl.protocol.serialization.streams.ByteArrayReaderOutputStream
...
class ByteArrayReaderOutputStreamSpec extends Specification {
    ...
    def "Testing Transformation Function with a Bitcoin Version Message"() {
        ...
        OutputStreamDestination<ByteArrayReader> destination = new OutputStreamDestinationImpl<>(executor)
        ...
        OutputStream<ByteArrayReader> myOutputStream = new ByteArrayReaderOutputStream(executor, destination, REF_BODY_ADDRESS, config)
