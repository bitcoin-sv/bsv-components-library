...
class VerackSerializationSpec extends Specification {
    ...
    def "Testing Verack Full Message Deserializing"() {
        given:
        ...
        when:
            version = bitcoinSerializer.<VersionAckMsg>deserialize(context,
                    new ByteArrayReader(HEX.decode(VERACK_MSG)), VersionAckMsg.MESSAGE_TYPE)
        then:
