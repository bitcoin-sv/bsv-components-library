...
import com.nchain.jcl.net.protocol.messages.PartialBlockRawDataMsg;
 ...
 */
public final class BlockRawDataDownloadedEvent extends MsgReceivedEvent<PartialBlockRawDataMsg> {
    public BlockRawDataDownloadedEvent(PeerAddress peerAddress, BitcoinMsg<PartialBlockRawDataMsg>  blockRawDataMsg) {
        super(peerAddress, blockRawDataMsg);
    }
}
