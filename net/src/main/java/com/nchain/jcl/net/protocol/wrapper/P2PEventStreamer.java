...
public class P2PEventStreamer {
    ...
    public class MsgsEventStreamer {
        ...
        public final EventStreamer<MsgReceivedEvent> GETHEADERSEN   = new EventStreamer<>(eventBus, MsgReceivedEvent.class, getFilterForMsgReceived(GetHeadersEnMsg.MESSAGE_TYPE));
        ...
        public final EventStreamer<MsgSentEvent> GETHEADERSEN_SENT  = new EventStreamer<>(eventBus, MsgSentEvent.class, getFilterForMsgSent(GetHeadersEnMsg.MESSAGE_TYPE));
    }
