 ...
 * -
 */
public class DiscoveryHandlerImpOriginal extends HandlerImpl implements DiscoveryHandler {
    ...
    /** Constructor */
    public DiscoveryHandlerImpOriginal(String id, RuntimeConfig runtimeConfig, DiscoveryHandlerConfig config) {
