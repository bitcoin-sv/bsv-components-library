 ...
 */
public class PingPongHandlerImplOriginal extends HandlerImpl implements PingPongHandler {
    ...
    /** Constructor */
    public PingPongHandlerImplOriginal(String id, RuntimeConfig runtimeConfig, PingPongHandlerConfig config) {
