 ...
 */
public class MessageHandlerImploriginal extends HandlerImpl implements MessageHandler {
    ...
    /** Constructor */
    public MessageHandlerImploriginal(String id, RuntimeConfig runtimeConfig, MessageHandlerConfig config) {
