...
public class BlockHeaderSimpleMsg extends Message implements Serializable {
    ...
    public BlockHeaderSimpleMsg(HashMsg hash, long version, HashMsg prevBlockHash, HashMsg merkleRoot, long creationTimestamp, long difficultyTarget, long nonce) {
        this.hash = hash;
