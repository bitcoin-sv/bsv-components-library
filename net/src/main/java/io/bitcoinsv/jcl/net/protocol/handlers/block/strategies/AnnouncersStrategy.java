...
import static io.bitcoinsv.jcl.net.protocol.handlers.block.strategies.DownloadResponse.*;
...
public class AnnouncersStrategy extends PriorityStrategy implements BlockDownloadStrategy {
    ...
    public AnnouncersStrategy(EventBus eventBus,
        ...
        super(BestMatchCriteria.FROM_ANNOUNCERS, eventBus);
    ...
    public Optional<DownloadResponse> requestDownload(
        ...
        if (result.isEmpty()) {
            if (isBlockAnnouncedBy(blockHash, peerAddress)) {
                ...
                return Optional.of(new DownloadResponse(request, DownloadResponseState.OTHER_PEER_ANNOUNCER));
                ...
                if (bestMatchNotAvailableAction.equals(BestMatchNotAvailableAction.DOWNLOAD_FROM_ANYONE)) {
                ...
                if (noBestMatchAction.equals(NoBestMatchAction.DOWNLOAD_FROM_ANYONE)) {
                    ...
                    return Optional.of(new DownloadResponse(request, DownloadResponseState.NO_ANNOUNCERS));
                }
            }
        }
        return result;
