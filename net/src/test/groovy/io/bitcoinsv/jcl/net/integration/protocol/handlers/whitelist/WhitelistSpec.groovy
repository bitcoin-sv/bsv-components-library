package io.bitcoinsv.jcl.net.integration.protocol.handlers.whitelist
...
class WhitelistSpec extends Specification {
    ...
    def "testing blacklisting/removing from Blacklist"() {
        ...
        when:
            ...
            PeerAddress peerBlacklistedThenWhitelisted = peersToBlacklist.get(0);
            List<PeerAddress> peersToWhitelist = new ArrayList<PeerAddress>();
