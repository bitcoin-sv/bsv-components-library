...
class NetAddressSerializationSpec extends Specification {
    ...
    def "Testing NetAddress Deserializing"(int byteInterval, int delayMs) {
        given:
            ...
            ByteArrayReader byteArrayReader = io.bitcoinsv.bsvcl.net.unit.protocol.tools.ByteArrayArtificalStreamProducer.stream(Utils.HEX.decode(REF_ADDRESS_MSG), byteInterval, delayMs);
        when:
