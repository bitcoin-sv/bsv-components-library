...
class VarStrMsgSerializationSpec extends Specification {
    ...
    def "testing De-serializing VarStr"(int byteInterval, int delayMs) {
        ...
        when:
            ...
            ByteArrayReader byteReader = io.bitcoinsv.bsvcl.net.unit.protocol.tools.ByteArrayArtificalStreamProducer.stream(varStrWhole, byteInterval, delayMs)
    ...
    def "testing Serializing VarStr"(int byteInterval, int delayMs) {
        ...
        when:
            ...
            ByteArrayReader byteReader = io.bitcoinsv.bsvcl.net.unit.protocol.tools.ByteArrayArtificalStreamProducer.stream(serializedBytes, byteInterval, delayMs)
