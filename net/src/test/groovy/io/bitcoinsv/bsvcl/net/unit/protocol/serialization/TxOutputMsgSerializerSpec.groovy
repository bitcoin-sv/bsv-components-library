...
class TxOutputMsgSerializerSpec extends Specification {
    ...
    def "Testing TxOutputMessage Deserializing"(int byteInterval, int delayMs) {
        given:
            ...
            ByteArrayReader byteReader = io.bitcoinsv.bsvcl.net.unit.protocol.tools.ByteArrayArtificalStreamProducer.stream(Utils.HEX.decode(REF_MSG), byteInterval, delayMs)
        when:
