  ...
  @Ignore  def "testing blockMessage BlockHeaderEnrichedMsg Serializing"() {
        given:
            ...
            io.bitcoinsv.bsvcl.net.protocol.serialization.common.SerializerContext context = io.bitcoinsv.bsvcl.net.protocol.serialization.common.SerializerContext.builder()
                    ...
                    .build()
            io.bitcoinsv.bsvcl.net.protocol.serialization.BlockHeaderEnMsgSerializer serializer = io.bitcoinsv.bsvcl.net.protocol.serialization.BlockHeaderEnMsgSerializer.getInstance()
