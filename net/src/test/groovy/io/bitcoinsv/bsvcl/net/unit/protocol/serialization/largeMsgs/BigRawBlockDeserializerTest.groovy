...
class BigRawBlockDeserializerTest extends Specification {
    ...
    def "Testing Big-Block Deserialized syncronously"() {
        given:
            ...
            final int NUM_TXS = 2
            String BLOCK_HEX = io.bitcoinsv.bsvcl.net.unit.protocol.tools.MsgTest.BLOCK_BODY_HEX
        ...
        when:
            ...
            // Deserializer set up:
            io.bitcoinsv.bsvcl.net.protocol.serialization.largeMsgs.RawBigBlockDeserializer bigBlockDeserializer = new io.bitcoinsv.bsvcl.net.protocol.serialization.largeMsgs.RawBigBlockDeserializer()
            ...
            bigBlockDeserializer.onDeserialized({ e ->
                ...
                else if (e.getData() instanceof io.bitcoinsv.bsvcl.net.protocol.messages.PartialBlockRawTxMsg) {
                    numTXsReceived.addAndGet(((io.bitcoinsv.bsvcl.net.protocol.messages.PartialBlockRawTxMsg) e.getData()).txs.size() )
                    txIndexesReceived.add(((io.bitcoinsv.bsvcl.net.protocol.messages.PartialBlockRawTxMsg) e.getData()).txsIndexNumber.value);
