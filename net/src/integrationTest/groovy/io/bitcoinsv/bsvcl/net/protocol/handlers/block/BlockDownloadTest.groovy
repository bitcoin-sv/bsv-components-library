...
//            "0000000000000000061757aed9f19d4e6a94ad5f309d1cc53f4303298cbf033f" // 2.2MB
    ...
    def "Testing Block Downloading"() {
        ...
        P2P p2p = new P2PBuilder("testing")
            ...
            Map<String, io.bitcoinsv.bsvcl.net.protocol.messages.BlockHeaderMsg> blockHeaders = new ConcurrentHashMap<>()    // Block Headers
            ...
            io.bitcoinsv.bsvcl.net.protocol.handlers.block.BlockDownloaderHandlerState downloadState = null;
            ...
            p2p.EVENTS.STATE.BLOCKS.forEach( {e ->
                println(e)
                downloadState = (io.bitcoinsv.bsvcl.net.protocol.handlers.block.BlockDownloaderHandlerState) e.getState();
        ...
        where:
           ...
           new io.bitcoinsv.bsvcl.net.protocol.config.provided.ProtocolBSVMainConfig() |   BLOCKS_BSV_MAIN | BLOCKS_BSV_MAIN_TO_CANCEL
