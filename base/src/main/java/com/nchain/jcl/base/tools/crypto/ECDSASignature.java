...
public class ECDSASignature {
    ...
    @NonNull public final BigInteger r;
    @NonNull public final BigInteger s;
    ...
    public static ECDSASignature dummy() {
        return new ECDSASignature(ECDSA.HALF_CURVE_ORDER, ECDSA.HALF_CURVE_ORDER);
    }
