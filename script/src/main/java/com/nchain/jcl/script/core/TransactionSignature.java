...
import com.nchain.jcl.base.tools.crypto.ECDSASignature;
...
public class TransactionSignature extends ECDSASignature {
    ...
    public TransactionSignature(BigInteger r, BigInteger s, Integer sighashFlags) {
        super(r, s);
        this.sighashFlags = (sighashFlags != null) ? sighashFlags : SigHash.Flags.ALL.value;
    }
    ...
    public static TransactionSignature dummy() {
        ...
        return TransactionSignature.builder().r(val).s(val).build();
    }
    ...
    public static TransactionSignature decodeFromBitcoin(byte[] bytes,
        ...
        return TransactionSignature.builder().r(sig.r).s(sig.s).sighashFlags((int) bytes[bytes.length - 1]).build();
    }
}
