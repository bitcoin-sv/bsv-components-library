...
class BlockStorePosixWaitTest extends Specification {
    ...
    private final long WAIT_DELAY = io.bitcoinsv.bsvcl.tools.blobStore.BlockStorePosix.WAIT_DELAY.toMillis();
     ...
     */
    class DummyWaitStore extends io.bitcoinsv.bsvcl.tools.blobStore.BlockStorePosix {
