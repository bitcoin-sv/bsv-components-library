package io.bitcoinsv.bsvcl.tools.performance.chainStore
    ...
    def "testing forking & prunning with long trunks"() {
        ...
        when:
            ...
            for (int i = 0; i < FORK_CHAIN_LENGTH; i++) {
                ...
                io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<NodeTest> pathNodeMainChain = treeNode.getPath(i, String.valueOf(FORK_HEIGHT + i), true)
                io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<NodeTest> pathNodeFork = treeNode.getPath(i, String.valueOf(FORK_HEIGHT + i) + "B", true)
