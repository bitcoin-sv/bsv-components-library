...
class ChainPathSpec extends Specification {
    ...
    def "testing node existence, height zero"() {
        ...
        when:
        io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path, 0)
            // Found:
    ...
    def "testing node existence, height not zero"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path, 2)
            // Found:
    ...
    def "testing getting Blocks in a Chain with height Not Zero"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path, 3)
            Optional<String> nodeA = chainPath.getNode(0)
    ...
    def "testing Fork Comparison, same height"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath1 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 0)
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath2 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path2, 0)
    ...
    def "testing Fork Comparison, different height, this lower than other"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath1 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 0)
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath2 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path2, 2)
            Integer forkPoint = chainPath1.getForkPoint(chainPath2)
        then:
            forkPoint == 3
    }
    ...
    def "testing Fork Comparison, different height, this higher than other"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath1 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 2)
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath2 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path2, 0)
            Integer forkPoint = chainPath1.getForkPoint(chainPath2)
        then:
            forkPoint == 3
    ...
    def "testing Fork Comparison, no overlap"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath1 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 0)
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath2 = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path2, 10)
            Integer forkPoint = chainPath1.getForkPoint(chainPath2)
        then:
            forkPoint == null
    }
    ...
    def "testing getting subList of Blocks"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 0)
    ...
    def "testing getting subList of Blocks, height before Path"() {
        ...
        when:
            io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<String> chainPath = new io.bitcoinsv.bsvcl.tools.chainStore.ChainPath<>(path1, 3)
