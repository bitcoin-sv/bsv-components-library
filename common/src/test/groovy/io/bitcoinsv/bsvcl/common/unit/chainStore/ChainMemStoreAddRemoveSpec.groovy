...
class ChainMemStoreAddRemoveSpec extends Specification {
    ...
    def "adding Nodes to Trunk"() {
        ...
        when:
            ...
            // Only Up to the Node:
        io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> wholePath = treeNode.getPath(0, "3", false)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> partialPath = treeNode.getPath(1, "2", false)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> notFoundPath = treeNode.getPath(2, "6", false)

            // Now, including children after the Node and up to next fork:
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> wholePath2 = treeNode.getPath(0, "3", true)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> partialPath2 = treeNode.getPath(1, "2", true)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> notFoundPath2 = treeNode.getPath(2, "6", true)
    ...
    def "adding Branches"() {
        ...
        when:
            ...
            // Only up to the Node:
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path1 = treeNode.getPath(0, "5", false)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path2 = treeNode.getPath(0, "1", false)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path3 = treeNode.getPath(1, "3B", false)

            // including children AFTER the node and up to next fork
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path1B = treeNode.getPath(0, "5", true)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path2B = treeNode.getPath(0, "1", true)
            io.bitcoinsv.bsvcl.common.chainStore.ChainPath<NodeTest> path3B = treeNode.getPath(1, "3B", true)
