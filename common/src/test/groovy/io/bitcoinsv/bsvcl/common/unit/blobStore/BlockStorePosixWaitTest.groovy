package io.bitcoinsv.bsvcl.common.unit.blobStore
...
class BlockStorePosixWaitTest extends Specification {
    ...
    private final long WAIT_DELAY = io.bitcoinsv.bsvcl.common.blobStore.BlockStorePosix.WAIT_DELAY.toMillis();
     ...
     */
    class DummyWaitStore extends io.bitcoinsv.bsvcl.common.blobStore.BlockStorePosix {
